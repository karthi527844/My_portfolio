        ...
        <div className="row">
          ...
          <div className="col-md-6 col-xl-6 col-lg-6 col-xs-12 about_content">
            ...
            <p>
              ...
              voluptatibus illo eos pariatur ipsum ut molestiae quis, reiciendis
              possimus cumque quia laborum dolores neque adipisci minima
              accusantium eaque? Lorem ipsum dolor sit amet consectetur
